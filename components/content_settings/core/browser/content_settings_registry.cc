...
void ContentSettingsRegistry::Init() {
  ...
  Register(ContentSettingsType::CONTENT_SETTINGS_TYPE_DESKTOP_VIEW, "desktop-view",
  ...
  Register(ContentSettingsType::CONTENT_SETTINGS_TYPE_PLAY_VIDEO_IN_BACKGROUND, "play-video-in-background",
  ...
  Register(ContentSettingsType::CONTENT_SETTINGS_TYPE_PLAY_YT_VIDEO_IN_BROWSER, "play-yt-video-in-browser",
